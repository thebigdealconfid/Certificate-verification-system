			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h1 class="white-text">Welcome to Jtech</h1>
						<p class="lead white-text">We are here to serve you.</p>
						<p class="lead h5 white-text">** <b>Certificate verification Platform</b> **</p>
						
						<a class="main-button icon-button" href="./">Lets Get Started</a>
					</div>
				</div>
			</div>
		</div>
