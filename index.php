...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h1 class="white-text">Welcome to Jtech cert</h1>
						<p class="lead white-text">Here To Serve You</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="contact-call-to-action" class="section">
		...
		<!-- Backgound Image -->
		<div class="bg-image bg-parallax overlay ed-bg-color-g"></div>
		<!-- Backgound Image -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					...
					<p class="lead white-text">appreciate what we Doing ? And You Would Like To Support Or let us know</p>
